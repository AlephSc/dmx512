# DMX512 Controller â€” Desktop .exe
...
2. Pilih COM port USB ke ESP32 â†’ tombol **SAMBUNG**.
3. Gunakan tab:
...
5. Sinkron dua arah: jika Anda menggeser fader di browser (WiFi), tampilan `.exe` ikut berubah dalam â‰¤250 ms â€” dan sebaliknya.
...
- Protocol serial sangat ringan â€” tidak perlu library tambahan kecuali `pyserial`.
